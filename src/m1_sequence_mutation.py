...
def run_test_zero_changer():
    ...
    test2 = ([5, 32, 5], [7, 0, 23, 0, 4, 6], [23, 0], [3, 3, 3])
    expected2 = ([5, 32, 5], [7, 1, 23, 2, 4, 6], [23, 3], [3, 3, 3])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    test3 = ([2, 0, 4, 5], [67, 78, 0, 9, 10], [0, 0], [4, 5, 6])
    expected3 = ([2, 1, 4, 5], [67, 78, 2, 9, 10], [3, 4], [4, 5, 6])
    zero_changer(test3)
    print()
    print('Test 3:')
